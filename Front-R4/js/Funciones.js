function traerInformacionCategorias(){
    $.ajax({
        url:"http://150.230.73.244/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://150.230.73.244/api/Category/save",
...
function borrarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Category/"+idElemento,
        type:'DELETE',
        data:dataToSend,
...
function actualizarInformacionCategorias(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Category/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function traerInformacionOrtopedic(){
    $.ajax({
        url:"http://150.230.73.244/api/Ortopedic/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionOrtopedic(){
    let var3 = {
        ...
        url:"http://150.230.73.244/api/Ortopedic/save",
...
function borrarInformacionOrtopedic(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Ortopedic/"+idElemento,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/json',
        dataType:'JSON',
...
function actualizarInformacionOrtopedic(idElemento){ 
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Ortopedic/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/JSON',
        dataType: 'JSON', 
...
function traerInformacionClient(){
    $.ajax({
        url:"http://150.230.73.244/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionClient(){
    let var4 = {       
        ...
        url:"http://150.230.73.244/api/Client/save",
...
function actualizarInformacionClient(idElemento){ 
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Client/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function borrarInformacionClient(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Client/"+idElemento,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/json',
        dataType:'JSON',
...
function traerInformacionMessage(){
    $.ajax({
        url:"http://150.230.73.244/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionMessage(){
    let var5 = {
        ...
        url:"http://150.230.73.244/api/Message/save",
...
function actualizarInformacionMessage(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Message/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/JSON',
        dataType: 'JSON', 
...
function borrarInformacionMessage(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Message/"+idElemento,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/json',
        dataType:'JSON',
...
function traerInformacionReservation(){
    $.ajax({
        url:"http://150.230.73.244/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionReservation(){
    let var6 = {
        ...
        url:"http://150.230.73.244/api/Reservation/save",
...
function actualizarInformacionReservation(idElemento){ 
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Reservation/update",
        type:'PUT',
        data:dataToSend,
        contentType:'application/json',
        dataType: 'JSON', 
...
function borrarInformacionReservation(idElemento){
    ...
    $.ajax({
        url:"http://150.230.73.244/api/Reservation/"+idElemento,
        type:'DELETE',
        data:dataToSend,
        contentType:'application/JSON',
        dataType:'JSON',
